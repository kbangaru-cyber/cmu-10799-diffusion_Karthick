...
Usage:
    # Train DDPM
    python train.py --method ddpm_x0 --config configs/ddpm.yaml

    # Resume training
    python train.py --method ddpm_x0 --config configs/ddpm.yaml --resume checkpoints/ddpm_50000.pt
"""
...
def train(
    ...
    if method_name == 'ddpm_x0':
        ...
        raise ValueError(f"Unknown method: {method_name}. Only 'ddpm_x0' is supported in train_x0.py.")
# Create optimizer
...
def main():
    ...
    parser.add_argument('--method', type=str, required=True,
                       choices=['ddpm_x0'], # You can add more later
